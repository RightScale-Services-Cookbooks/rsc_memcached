...
module RsApplicationMemcached
  # This module contains helper methods for rsc_memcached cookbook.
  #
  module Helper
    ...
    def self.get_bind_ip_address(node)
      case node['rsc_memcached']['bind_network_interface']
      when "private"
      ...
      when "public"
        ...
        raise "Unknown network interface '#{node['rsc_memcached']['bind_network_interface']}'!" +
